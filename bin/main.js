        ...
        function init() {
            ...
            if (global.compatibility.svg) {
                ...
                if(!global.compatibility.istouchable()) {
                    global.hud.addHUDItem($('#square-paint'), '<div class="menu-button-container" id="paint-selection-tool-container" title="Toggle square selection"><img src="images/icons/Button_Brush_Tool.png" class="square-paint-toggle menu-item" alt="sqr"><img src="images/icons/Button_Rectangular_Selection_Tool.png" class="square-paint-toggle menu-item" alt="sqr"></div>');
                }
